 ...
 * ("boolean" - devem come�ar como "true").
 *
 * c) Crie uma fun��o que receba um "objeto" fruta por par�metro e coloque-a
 * dentro do "array" de "carrinho". Invoque essa fun��o passando os tr�s objetos criados.
 * Dica: aqui voc� deve usar o m�todo "push()".
 *
